...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all locations whose fields match the "
            ...
            + "Search by multiple prefixes (a/, t/, d/) uses AND logic.\n"
            + "Parameters: [NAME_KEYWORD]... [a/ADDRESS] [t/TAG]... [d/DATE]\n"
            + "Example: " + COMMAND_WORD + " alice t/important a/Clementi d/2024-01-15";
