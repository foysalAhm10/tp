...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // while parsing {@code PREFIX_TAG} alone will reset the tags of the {@code Location} being edited,
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // phone
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY;
        descriptor = new EditLocationDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_AMY;
        descriptor = new EditLocationDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // address
        userInput = targetIndex.getOneBased() + ADDRESS_DESC_AMY;
        descriptor = new EditLocationDescriptorBuilder().withAddress(VALID_ADDRESS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // tags
        userInput = targetIndex.getOneBased() + TAG_DESC_FRIEND;
        descriptor = new EditLocationDescriptorBuilder().withTags(VALID_TAG_FRIEND).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_resetTags_success() {
        ...
        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_tagAdd_success() {
        Index targetIndex = INDEX_FIRST_LOCATION;
        String userInput = targetIndex.getOneBased() + " t+/friend";

        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder()
                .withTagsToAdd("friend")
                .build();
    ...
    @Test
    public void parse_tagRemove_success() {
        Index targetIndex = INDEX_FIRST_LOCATION;
        String userInput = targetIndex.getOneBased() + " t-/friend";

        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder()
                .withTagsToRemove("friend")
                .build();
    ...
    @Test
    public void parse_tagAddAndRemove_success() {
        Index targetIndex = INDEX_FIRST_LOCATION;
        String userInput = targetIndex.getOneBased() + " t+/friend t-/enemy";

        EditLocationDescriptor descriptor = new EditLocationDescriptorBuilder()
                .withTagsToAdd("friend")
                .withTagsToRemove("enemy")
                .build();
    ...
    @Test
    public void parse_sameTagAddAndRemove_success() {
        Index targetIndex = INDEX_FIRST_LOCATION;
        String userInput = targetIndex.getOneBased() + " t+/friend t-/friend";
